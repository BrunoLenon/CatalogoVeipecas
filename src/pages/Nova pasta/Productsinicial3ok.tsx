  ...
  const handleImportExcel = async (file: File) => {
    ...
    reader.onload = async (event) => {
      try {
        ...
        setSelectedItems(new Set(jsonData.map((_, index) => index))); // Selecionar todos por padrão
            ...
            >
              ...
              {isImporting && !isPreviewModalOpen && (
                <div className="w-full bg-gray-200 rounded-full h-4">
                  <div
                    className="bg-indigo-600 h-4 rounded-full transition-all duration-200 text-right pr-2 text-white text-xs font-semibold flex items-center justify-end"
