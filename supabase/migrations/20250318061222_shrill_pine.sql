...
DROP POLICY IF EXISTS "allow_insert_custom" ON custom;
DROP POLICY IF EXISTS "allow_update_custom" ON custom;
DROP POLICY IF EXISTS "allow_delete_custom" ON custom;
...
DROP POLICY IF EXISTS "allow_public_read_system_images" ON storage.objects;
DROP POLICY IF EXISTS "allow_admin_manage_system_images" ON storage.objects;
