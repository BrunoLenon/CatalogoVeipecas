...
CREATE POLICY "rls_company_info_select_all_20250317_v4"
  ON company_info
  FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "rls_company_info_insert_admin_20250317_v4"
  ON company_info
  FOR INSERT
  TO authenticated
  WITH CHECK (
...
CREATE POLICY "rls_company_info_update_admin_20250317_v4"
  ON company_info
  FOR UPDATE
  TO authenticated
  USING (
...
CREATE POLICY "rls_company_info_delete_admin_20250317_v4"
  ON company_info
  FOR DELETE
  TO authenticated
  USING (
...
CREATE POLICY "rls_storage_select_images_20250317_v3"
ON storage.objects
FOR SELECT
TO public
USING (bucket_id = 'imagens');

CREATE POLICY "rls_storage_insert_images_20250317_v3"
ON storage.objects
FOR INSERT
TO authenticated
WITH CHECK (
...
CREATE POLICY "rls_storage_update_images_20250317_v3"
ON storage.objects
FOR UPDATE
TO authenticated
USING (
...
CREATE POLICY "rls_storage_delete_images_20250317_v3"
ON storage.objects
FOR DELETE
TO authenticated
USING (
